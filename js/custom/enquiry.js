							...
							// $('#btn_reset_enquiry').click(function(event)
							// {
							// 	resetEnquiryForm();
							// });	
			 				...
			 				if(validate())
			 				{
			 					...
			 					form_data.append("purposeOfVisit",$('#purposeOfVisit').val());
			 					form_data.append("referredBy",$('#referredBy').val());
			 					form_data.append("country",$('#country').val());
			 					form_data.append("referDetails",$('#referDetails').val());
			 					form_data.append("message",$('#message').val());
			 					form_data.append("employeeId",window.sessionStorage.getItem('empId'));
			 					...
			 					$.ajax({
			 					 ...
			 					 {
			 					 		if($.trim(data)=='Student details saved successfully'){
			 					 			resetEnquiryForm();
			 					 		}
